...
func NewServer(addr string, handler http.Handler, shutdownTime, startTime time.Duration) *Server {
	isGraceful := false
...
func ListenAndServe(addr string, handler http.Handler) error {
	...
	return NewServer(addr, handler, shutdownTime, startTime).ListenAndServe()
}

func ListenAndServeWithTimeout(addr string, handler http.Handler, shutdownTime, startTime time.Duration) error {
	return NewServer(addr, handler, shutdownTime, startTime).ListenAndServe()
}
